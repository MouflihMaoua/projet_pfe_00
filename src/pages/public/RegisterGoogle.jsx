...
const RegisterGoogle = () => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case 'codePostal':
        ...
        break;
      case 'description':
        if (role === 'artisan' && (!value || value.trim().length < 10)) {
  ...
  const validateForm = () => {
    ...
    if (role === 'artisan') {
      fields.push('description', 'metier');
  ...
  const validateStep2 = () => {
    ...
    if (role === 'artisan') required.push('description');
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        value={formData.cin}
                        onChange={handleChange}
                        className={`w-full px-5 py-4 bg-gray-50 rounded-2xl border ${getFieldClassName('cin')} focus:bg-white outline-none transition-all shadow-sm`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full px-5 py-4 bg-gray-50 rounded-2xl border border-transparent focus:border-brand-orange focus:bg-white outline-none transition-all shadow-sm"
                        />
                      </div>
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <button
                    ...
                    className="w-full bg-brand-orange text-white py-5 rounded-2xl font-bold shadow-xl shadow-brand-orange/20 hover:bg-brand-orange/90 transition-all flex items-center justify-center group disabled:opacity-70"
                  >
                    {isSubmitting ? (
