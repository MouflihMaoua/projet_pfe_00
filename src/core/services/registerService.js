...
export async function registerUser({
  ...
  if (role === 'artisan') {
    ...
    const payload = {
      id_artisan: userId,
      nom_artisan: formData.nom.trim(),
      prenom_artisan: formData.prenom.trim(),
      email_artisan: formData.email.trim(),
      telephone_artisan: formData.telephone.trim(),
      sexe: formData.sexe,
      ...
      code_postale_artisan: formData.codePostal.trim(),
