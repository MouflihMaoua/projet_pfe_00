              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    onChange={(e) => setProfile(p => ({ ...p, numeroCIN: e.target.value }))}
                    className="w-full border border-gray-300 rounded-lg px-3 py-2"
                  ...
                  {isEditing ? (
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      {profile.carteCINRecto ? (
                        <img src={profile.carteCINRecto} alt="CIN Recto" className="w-full h-32 object-cover" />
                      ) : (
                  ...
                  {isEditing ? (
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      {profile.carteCINVerso ? (
                        <img src={profile.carteCINVerso} alt="CIN Verso" className="w-full h-32 object-cover" />
                      ) : (
                        <div className="h-32 flex items-center justify-center bg-gray-50">
                          <p className="text-sm text-gray-500">Aucun fichier</p>
                        </div>
